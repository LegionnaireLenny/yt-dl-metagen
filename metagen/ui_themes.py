...
set_widget_theme(theme=light_tan_theme,
...
set_widget_theme(theme=blue_theme,
                 widget_names=button_names,
                 widget_type="button",
...
purple_theme = {
    ...
    "scrollbar_inactive": modify_color("mediumslateblue", 0.7, 255),
    # Window colors
    "window_background": modify_color("darkslateblue", 0.6, 255),
    "title_bar_background": get_tinted_color(rgb_value=modify_color("darkslateblue", 1.2, 255)),
    # Title bar previous action button
    "title_bar_action_previous_text": modify_color("gold", 0.7, 255),
    # Title bar minimize button
    "title_bar_minimize_button_background": colormap["beige"],
    # Title bar maximize button
    "title_bar_maximize_button_background": colormap["beige"],
...
set_widget_theme(theme=purple_theme,
                 widget_names=button_names,
                 widget_type="button",
                 background=modify_color("darkslateblue", 1.2, 255),
                 border=border_themes["border_medium"],
                 text=modify_color("gold", 0.7, 255))

set_widget_theme(theme=purple_theme,
                 widget_names=text_input_names,
                 widget_type="text_input",
                 background=modify_color("darkslateblue", 1, 255),
                 border=border_themes["border_medium"],
                 text=modify_color("gold", 0.7, 255),
                 hint=modify_color("gold", 0.7, 150),
                 selection=modify_color("skyblue", 1, 100))

ui_theme = purple_theme
